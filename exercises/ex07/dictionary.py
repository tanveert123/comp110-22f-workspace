...
def invert(a: dict[str, str]) -> dict[str, str]:
   ...
   if repetetion == True:
     raise KeyError('Invert function cannot handle 2 people with same last names! Add another name!')
   else:
     return new_dict
...
def favorite_color(n_and_f: dict[str, str]) -> str:
    ...
    # else:
    #     return color
    print(f"High: {high}, Next High: {second_high}")
